...
Embedded model indexes
======================

``EmbeddedModelIndex``
----------------------

.. class:: EmbeddedModelIndex(**kwargs)

    .. versionadded:: 6.0.2

    Subclass of :class:`~django.db.models.Index` for use on a model with an
    embedded model in order to add an index on embedded fields.
