...
- Added :class:`~django_mongodb_backend.indexes.EmbeddedModelIndex` and
  :class:`~django_mongodb_backend.constraints.EmbeddedModelUniqueConstraint`
  to index embedded model fields.
